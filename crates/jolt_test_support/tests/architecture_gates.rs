...
const MAX_IMPLEMENTATION_NET_DELTA: usize = 1_732;

const ERROR_NODE_SITE_LIMITS: &[(&str, usize)] = &[
    (
        "crates/jolt_java_syntax/src/parser/grammar/compilation_unit.rs",
        1,
    ),
    (
    ...
    ("crates/jolt_java_syntax/src/parser/grammar/types.rs", 4),
    (
...
#[test]
fn implementation_projection_stays_within_phase_ten_budget() {
    let workspace = workspace_root();
    ...
    assert!(
        ...
        "Phase 10 implementation projection against {IMPLEMENTATION_BASELINE} is \
