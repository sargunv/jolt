...
const MAX_IMPLEMENTATION_NET_DELTA: usize = 4_850;
...
#[test]
fn implementation_projection_stays_within_phase_eighteen_budget() {
    let workspace = workspace_root();
    ...
    assert!(
        ...
        "Phase 18 implementation projection against {IMPLEMENTATION_BASELINE} is \
