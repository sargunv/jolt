...
const MAX_IMPLEMENTATION_NET_DELTA: usize = 5_058;
...
#[test]
fn implementation_projection_stays_within_phase_nineteen_budget() {
    let workspace = workspace_root();
    ...
    assert!(
        ...
        "Phase 19 implementation projection against {IMPLEMENTATION_BASELINE} is \
