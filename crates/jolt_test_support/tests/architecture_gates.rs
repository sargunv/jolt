...
const MAX_IMPLEMENTATION_NET_DELTA: usize = 4_482;
...
#[test]
fn implementation_projection_stays_within_phase_seventeen_budget() {
    let workspace = workspace_root();
    ...
    assert!(
        ...
        "Phase 17 implementation projection against {IMPLEMENTATION_BASELINE} is \
