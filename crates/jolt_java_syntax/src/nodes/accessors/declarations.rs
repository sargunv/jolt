use super::super::{
    Annotation, AnnotationArgumentList, AnnotationElementDeclaration, AnnotationElementList,
    ...
    ConstructorBody, ConstructorDeclaration, DefaultValue, EmptyDeclaration, EnumBody,
    ...
    LocalVariableDeclaration, MethodDeclaration, ModifierList, NameSyntax, PermitsClause,
    RecordBody, RecordComponent, RecordComponentList, RecordDeclaration, StaticInitializer,
    ThrowsClause, Type, TypeParameter, TypeParameterList, VariableDeclarator,
    VariableDeclaratorList, VariableInitializer, VariableInitializerValue, child, child_family,
...
impl EnumBody {
    ...
    pub fn has_supported_layout_shape(&self) -> bool {
        ...
        elements[index..elements.len().saturating_sub(1)]
            .iter()
            .all(|element| element.kind() == JavaSyntaxKind::ClassBodyDeclaration)
    }
}
...
impl LocalVariableDeclaration {
    ...
    pub fn has_supported_layout_shape(&self) -> bool {
        ...
        matches!(
            kinds.as_slice(),
            [ty, JavaSyntaxKind::VariableDeclaratorList]
                if Type::can_cast(*ty) || *ty == JavaSyntaxKind::Identifier
        )
    }
}
impl Annotation {
